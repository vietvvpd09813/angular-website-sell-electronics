...
@Component({
  selector: 'app-editcategori35',
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule],
  templateUrl: './editcategori35.component.html',
  styleUrl: './editcategori35.component.css'
})
export class Editcategori35Component implements OnInit {
